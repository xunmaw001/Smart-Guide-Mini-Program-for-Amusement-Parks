...
export default {
  ...
  computed: {
    ...
    zongjia:{
      get: function () {
        return 1*this.ruleForm.danjia*this.ruleForm.piaoshu
      }
    },
  ...
  methods: {
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../ssm58889/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.piaoshu = objcross.piaoshu - this.ruleForm.piaoshu
	      if(objcross.piaoshu<0){
