<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开卖时间" prop="kaimaishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.kaimaishijian" 
                type="datetime"
                :readonly="ro.kaimaishijian"
                placeholder="开卖时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaimaishijian" label="开卖时间" prop="kaimaishijian">
              <el-input v-model="ruleForm.kaimaishijian" 
                placeholder="开卖时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购票地点" prop="goupiaodidian">
          <el-input v-model="ruleForm.goupiaodidian" 
              placeholder="购票地点" clearable  :readonly="ro.goupiaodidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购票地点" prop="goupiaodidian">
              <el-input v-model="ruleForm.goupiaodidian" 
                placeholder="购票地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="票务详情" prop="piaowuxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.piaowuxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.piaowuxiangqing" label="票务详情" prop="piaowuxiangqing">
                    <span v-html="ruleForm.piaowuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.kaimaishijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='kaimaishijian'){
            this.ruleForm.kaimaishijian = obj[o];
	    this.ro.kaimaishijian = true;
            continue;
          }
          if(o=='jieshushijian'){
	    ...
	    this.ro.jieshushijian = true;
          ...
          if(o=='goupiaodidian'){
            this.ruleForm.goupiaodidian = obj[o];
	    this.ro.goupiaodidian = true;
            continue;
          }
          if(o=='piaowuxiangqing'){
            this.ruleForm.piaowuxiangqing = obj[o];
	    this.ro.piaowuxiangqing = true;
            continue;
          }
          if(o=='thumbsupnum'){
	...
	this.ruleForm.piaowuxiangqing = this.ruleForm.piaowuxiangqing.replace(reg,'../../../ssm58889/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
